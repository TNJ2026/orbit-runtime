...
export const en = {
  ...
  workflowViews: 'Workflow detail views', workflowGraph: 'Graph', workflowDefinition: 'Definition',
  noWorkflowGraph: 'No graph is available for this workflow.', newGoal: 'New goal',
  editWorkflow: 'Modify', deleteWorkflow: 'Delete',
  deleteWorkflowTitle: 'Delete this workflow?', deleteCancel: 'Cancel', deleteConfirm: 'Delete',
...
export const zh = {
  ...
  workflowViews: '工作流详情视图', workflowGraph: '流程图', workflowDefinition: '定义列表',
  noWorkflowGraph: '这个工作流没有可显示的流程图。', newGoal: '新目标',
  editWorkflow: '修改', deleteWorkflow: '删除',
  deleteWorkflowTitle: '确认删除工作流？', deleteCancel: '取消', deleteConfirm: '确认删除',

	...
	factory: (require) => {
		...
		*/
		...
		var PromptaFlowPanel_module_css_default = {
			...
			"listActions": "jB2GrG_listActions",
		...
		*/
		...
		function PromptaFlowRunDetail({ call, t, sessionId, run, onBack }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [onBack ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BackButton, {
				t,
				onBack
		...
		*/
			...
			(0, react.useEffect)(() => {
				...
				const tick = async () => {
					try {
						...
						const unseenLiveAuthoring = !(priorAuthoring === void 0) && nextAuthoring.some((job) => (job.status === "queued" || job.status === "running") && !priorAuthoring.has(job.job_id));
						const remembered = priorAuthoring ?? /* @__PURE__ */ new Set();
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: chosen !== void 0 && sessionId !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PromptaFlowRunDetail, {
							...
							!connecting && error === null && rows !== null && sessionId !== void 0 && tab === "goal" ? goal.length ? goal.map((row) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PromptaFlowRunDetail, {
								call: hostCall$1,
								t,
								sessionId,
								run: row
							...
							!connecting && error === null && tab === "workflows" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [workflows.length ? workflows.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								className: PromptaFlowPanel_module_css_default.listActions,
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: PromptaFlowPanel_module_css_default.flowNewGoal,
									disabled: !sessionId,
									onClick: () => {
										if (sessionId) onGenerateWorkflow(sessionId);
									},
									children: t("generateWorkflowAction")
								})
							})] }) : null,
		...
		const en = {
			...
			generateWorkflowAction: "Generate workflow",
			generateWorkflowPrompt: "Generate a PromptaFlow workflow: ",
		...
		const zh = {
			...
			generateWorkflowAction: "生成工作流",
			generateWorkflowPrompt: "生成一个 PromptaFlow 工作流：",

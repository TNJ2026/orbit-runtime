	...
	factory: (require) => {
		...
		*/
		...
		var PromptaFlowPanel_module_css_default = {
			...
			"activityDot": "jB2GrG_activityDot",
			"addAgent": "jB2GrG_addAgent",
			"agentActions": "jB2GrG_agentActions",
			...
			"agentsSection": "jB2GrG_agentsSection",
			...
			"live": "jB2GrG_live",
			"liveStepRow": "jB2GrG_liveStepRow",
			"liveSteps": "jB2GrG_liveSteps",
			"meta": "jB2GrG_meta",
			...
			"panel": "jB2GrG_panel",
			"promptaflow-activity-pulse": "jB2GrG_promptaflow-activity-pulse",
		...
		*/
		function readLayout(raw) {
			...
			return {
				...
				width: clamp$1(finite(stored.width, 384), 320, 720),
				height: clamp$1(finite(stored.height, 420), 280, 720)
			};
		}
		...
		function placePanel(layout, bounds) {
			...
			if (layout.mode === "docked" || compact) {
				const top = 64;
				const available = Math.max(280, Math.min(720, bounds.height - top - 24));
				return {
			...
			const height = clamp$1(layout.height, 280, Math.max(280, Math.min(720, bounds.height - 24)));
			return {
		...
		function resizePanel(layout, dWidth, dHeight, bounds) {
			...
			return {
				...
				height: clamp$1(layout.height + dHeight, 280, Math.max(280, Math.min(720, bounds.height - 24)))
			};
		}
		//#endregion
		...
		*/
		...
		function PromptaFlowLiveStepList({ steps }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: PromptaFlowPanel_module_css_default.liveSteps,
				children: steps.map((item) => {
					const step = toStepRow(item);
					const indicator = stepDotState(step.status);
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: PromptaFlowPanel_module_css_default.liveStepRow,
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: `${PromptaFlowPanel_module_css_default.stepDot} ${PromptaFlowPanel_module_css_default[`stepDot_${indicator}`]}`,
								"aria-hidden": "true"
		...
		*/
		...
		function PromptaFlowRunGoalCard({ call, t, sessionId, run, steps }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.StateDot, {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("time", {
									className: PromptaFlowPanel_module_css_default.goalTime,
									dateTime: run.createdAt,
									children: formatRunTime(run.createdAt)
								}),
					...
					run.live && steps?.length ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PromptaFlowLiveStepList, { steps }) : null,
		...
		*/
		function RunControls({ call, t, sessionId, run }) {
			...
			const [busy, setBusy] = (0, react.useState)(false);
			const [rejecting, setRejecting] = (0, react.useState)(false);
			const [error, setError] = (0, react.useState)(null);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					}) : null, resumeAt === void 0 ? null : approval !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
						size: "sm",
						variant: "primary",
						disabled: busy,
						onClick: () => act("langgraph_run.resume", resumeAt, approvalValue(approval, "approve"), approval.id),
						children: busy ? t("working") : t("approve")
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								onClick: () => {
									setRejecting(false);
									act("langgraph_run.resume", resumeAt, approvalValue(approval, "reject", answer), approval.id);
								},
								children: busy ? t("working") : t("reject")
							})]
						})
					]
				}) : null,
		...
		*/
		...
		function PromptaFlowPanel({ t, useSessions, onSelectWorkflow, onAddAgent, onEditWorkflow, onDeleteWorkflow }) {
			...
			const [liveSteps, setLiveSteps] = (0, react.useState)({});
				...
				const tick = async () => {
					try {
						...
						setLiveSteps((current) => Object.fromEntries(next.filter((row) => row.live).flatMap((row) => {
							...
							return steps === void 0 ? [] : [[row.runId, steps]];
						})));
						...
						setAsking(false);
						setConnecting(false);
						const authoringLive = nextAuthoring.some((job) => job.status === "queued" || job.status === "running");
						timer = setTimeout(() => {
							tick();
			...
			const hasActiveWork = (rows ?? []).some((row) => row.live) || authoring.some((job) => job.status === "queued" || job.status === "running");
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: PromptaFlowPanel_module_css_default.titleGroup,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: PromptaFlowPanel_module_css_default.title,
									children: t("title")
								}), hasActiveWork ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: PromptaFlowPanel_module_css_default.activityDot,
									role: "status",
									"aria-label": t("activeWork")
								}) : null]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: chosen !== void 0 && sessionId !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PromptaFlowRunDetail, {
							...
							!connecting && error === null && tab === "agents" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: PromptaFlowPanel_module_css_default.agentsSection,
								children: [agents.length ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									className: PromptaFlowPanel_module_css_default.agentActions,
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: PromptaFlowPanel_module_css_default.addAgent,
										disabled: !sessionId,
										onClick: () => {
											if (sessionId) onAddAgent(sessionId);
										},
										children: t("addAgentCli")
									})
								})]
							}) : null
						] })
		...
		const en = {
			...
			closePanel: "Close PromptaFlow panel",
			...
			activeWork: "A goal or workflow authoring job is in progress",
			status: "Status",
			refresh: "Refresh",
			back: "Back",
			...
			approve: "Approve",
			reject: "Reject",
			rejectAsk: "Why is this being rejected? A rework reads it.",
			rejectCancel: "Back",
			reason: "Optional — leave empty to say nothing",
		...
		const zh = {
			...
			approve: "通过",
			reject: "拒绝",
			rejectAsk: "为什么驳回？返工时 Agent 会读到它。",
			rejectCancel: "返回",
			reason: "可以不填，留空就是没有原因",
			answer: "要用什么值继续？",

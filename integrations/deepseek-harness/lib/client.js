window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function approvalValue(interrupt, decision, reason) {
			const said = (reason ?? "").trim();
			return { [interrupt.outputPort]: {
				decision,
				value: said === "" ? null : said
			} };
		}
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/cxd/develop/orbit/.claude/worktrees/rework/integrations/deepseek-harness/src/client/OrbitPanel.module.css.mjs
		const css$1 = ".f1IgfW_panel,.f1IgfW_panel *,.f1IgfW_panel :before,.f1IgfW_panel :after{box-sizing:border-box}.f1IgfW_panel{border:1px solid var(--dsw-alias-border-l4,#80808033);background:var(--dsw-alias-bg-layer-1,Canvas);color:var(--dsw-alias-label-primary);pointer-events:auto;border-radius:12px;flex-direction:column;display:flex;position:absolute;overflow:hidden;box-shadow:0 12px 40px #0000002e}.f1IgfW_bar{border-bottom:1px solid var(--dsw-alias-border-l2,#8080801f);background:var(--dsw-alias-bg-module-platform,#80808014);cursor:grab;user-select:none;align-items:center;gap:8px;padding:8px 10px 8px 12px;display:flex}.f1IgfW_bar:active{cursor:grabbing}.f1IgfW_title{font-size:13px;font-weight:600}.f1IgfW_count{color:var(--dsw-alias-label-tertiary);flex:1;font-size:12px}.f1IgfW_body{flex:1;min-height:0;overflow-y:auto}.f1IgfW_row{border-bottom:1px solid var(--dsw-alias-border-l2,#8080801f);grid-template-columns:8px 1fr auto;align-items:start;gap:8px;padding:10px 12px;display:grid}.f1IgfW_row:last-child{border-bottom:0}.f1IgfW_dot{border-radius:50%;width:8px;height:8px;margin-top:5px}.f1IgfW_live{background:var(--dsw-alias-state-business-primary,#679efe)}.f1IgfW_done{background:var(--dsw-alias-state-success-primary,#22c55e)}.f1IgfW_failed{background:var(--dsw-alias-state-error-primary,#f25a5a)}.f1IgfW_unknown{background:var(--dsw-alias-state-warn-primary,#f59e0b)}.f1IgfW_goal{-webkit-line-clamp:2;-webkit-box-orient:vertical;font-size:13px;line-height:1.4;display:-webkit-box;overflow:hidden}.f1IgfW_meta{color:var(--dsw-alias-label-tertiary);font-size:11px}.f1IgfW_status{color:var(--dsw-alias-label-secondary,GrayText);white-space:nowrap;margin-left:8px;font-size:11px}.f1IgfW_empty,.f1IgfW_error{color:var(--dsw-alias-label-tertiary);text-align:center;padding:20px 14px;font-size:12px}.f1IgfW_error{color:var(--dsw-alias-state-error-primary);text-align:left}.f1IgfW_connecting{color:var(--dsw-alias-label-secondary,GrayText);justify-content:center;align-items:center;gap:9px;padding:24px 14px;font-size:12px;display:flex}.f1IgfW_connectSpinner{border:2px solid var(--dsw-alias-border-l3,#80808029);border-top-color:var(--dsw-alias-state-business-primary,Highlight);border-radius:50%;width:14px;height:14px;animation:.7s linear infinite f1IgfW_orbit-spin}.f1IgfW_badge{border:1px solid var(--dsw-alias-border-l4,#80808033);background:var(--dsw-alias-bg-layer-1,Canvas);width:42px;height:42px;color:var(--dsw-alias-label-secondary);cursor:pointer;pointer-events:auto;border-radius:999px;place-items:center;margin-top:-21px;padding:0;display:grid;position:absolute;top:50%;right:18px;box-shadow:0 6px 20px #00000024}.f1IgfW_badge:hover{transform:translateY(-1px)}.f1IgfW_orbitMark{width:30px;height:30px}.f1IgfW_orbitBackground{fill:var(--dsw-alias-label-primary)}.f1IgfW_orbitRing{fill:none;stroke:var(--dsw-alias-bg-layer-1,Canvas);stroke-width:6px}.f1IgfW_orbitSatellite{fill:var(--dsw-alias-state-business-primary,Highlight)}.f1IgfW_resize{cursor:nwse-resize;width:14px;height:14px;position:absolute;inset:auto 0 0 auto}.f1IgfW_stepDisclosure{width:100%;min-width:0}.f1IgfW_stepRow{width:100%;min-width:0;height:32px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;align-items:center;gap:8px;padding:4px 12px 4px 22px;font-size:12px;display:flex}.f1IgfW_stepRow:disabled{cursor:default}.f1IgfW_stepTitle{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.f1IgfW_stepChevron{color:var(--dsw-alias-label-tertiary,GrayText);flex:none;transition:transform .12s}.f1IgfW_stepChevronOpen{transform:rotate(180deg)}.f1IgfW_stepContent{padding:0 12px 4px 38px}.f1IgfW_stepDot{border-radius:50%;flex:none;width:8px;height:8px;display:block}.f1IgfW_stepDot_success{background:var(--dsw-alias-state-success-primary,#22c55e)}.f1IgfW_stepDot_error{background:var(--dsw-alias-state-error-primary,#f25a5a)}.f1IgfW_stepDot_skipped{background:var(--dsw-alias-label-tertiary,#adb2b8)}.f1IgfW_stepDot_warning{background:var(--dsw-alias-state-warn-primary,#f59e0b)}.f1IgfW_stepDot_ongoing{background:var(--dsw-alias-state-business-primary,#679efe)}.f1IgfW_attention{border-left:2px solid var(--dsw-alias-state-warn-primary,#f59e0b);color:var(--dsw-alias-label-secondary);margin:4px 0;padding:6px 8px;font-size:11px}.f1IgfW_actions{flex-wrap:wrap;align-items:center;gap:6px;margin:6px 0 8px;display:flex}.f1IgfW_runActions{justify-content:center;padding:0 12px}.f1IgfW_actions input{border:1px solid var(--dsw-alias-border-l3,#80808029);background:var(--dsw-alias-bg-layer-1,Canvas);min-width:0;color:var(--dsw-alias-label-primary);border-radius:6px;flex:140px;padding:4px 8px;font-size:11px}.f1IgfW_iconButton{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:4px;justify-content:center;align-items:center;padding:2px;display:inline-flex}.f1IgfW_iconButton:hover{color:var(--dsw-alias-label-primary)}.f1IgfW_iconButton:disabled{cursor:default}.f1IgfW_iconButton:disabled svg{animation:.7s linear infinite f1IgfW_orbit-spin}@keyframes f1IgfW_orbit-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.f1IgfW_iconButton:disabled svg,.f1IgfW_connectSpinner{opacity:.45;animation:none}}.f1IgfW_stopButton:hover{color:var(--dsw-alias-state-error-primary,LinkText)}.f1IgfW_confirmBar{border-bottom:1px solid var(--dsw-alias-border-l2,#8080801f);background:var(--dsw-alias-bg-module-platform,#80808014);gap:8px;padding:10px 12px;display:grid}.f1IgfW_confirmText{color:var(--dsw-alias-label-secondary,GrayText);font-size:12px;line-height:1.5}.f1IgfW_confirmActions{justify-content:flex-end;gap:8px;display:flex}.f1IgfW_confirmCancel,.f1IgfW_confirmGo{font:inherit;cursor:pointer;border-radius:6px;padding:4px 10px;font-size:12px}.f1IgfW_confirmCancel{border:1px solid var(--dsw-alias-border-l3,#80808029);background:var(--dsw-alias-bg-layer-1,Canvas);color:var(--dsw-alias-label-primary)}.f1IgfW_confirmGo{background:var(--dsw-alias-state-error-primary,Highlight);color:var(--dsw-alias-label-primary-foreground,#fff);border:0}.f1IgfW_confirmGo:disabled{opacity:.6;cursor:default}.f1IgfW_catalogRow{justify-content:space-between;align-items:baseline;gap:8px;padding:4px 0 4px 12px;display:flex}.f1IgfW_catalogRow>*{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.f1IgfW_catalogRow>span{flex:auto}.f1IgfW_catalogRow>code{flex:0 auto}.f1IgfW_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#8080801f);background:var(--dsw-alias-bg-module-platform,#80808014);flex:none;gap:2px;padding:6px 8px 0;display:flex}.f1IgfW_tab{color:var(--dsw-alias-label-tertiary,GrayText);cursor:pointer;background:0 0;border:0;border-bottom:2px solid #0000;flex:1 1 0;padding:6px 4px 8px;font-size:12px}.f1IgfW_tab:hover{color:var(--dsw-alias-label-primary,CanvasText)}.f1IgfW_tabActive{color:var(--dsw-alias-label-primary,CanvasText);border-bottom-color:var(--dsw-alias-state-business-primary,Highlight);font-weight:600}.f1IgfW_agentsGrid{gap:10px;padding:10px 12px;display:grid}.f1IgfW_agentCard{border:1px solid var(--dsw-alias-border-l3,#80808029);background:var(--dsw-alias-bg-layer-1,Canvas);border-radius:8px;gap:11px;padding:12px;transition:border-color .12s,background-color .12s;display:grid}.f1IgfW_agentCard:hover{border-color:var(--dsw-alias-state-business-primary,Highlight);background:var(--dsw-alias-bg-module-platform,#80808014)}.f1IgfW_agentHead{align-items:flex-start;gap:10px;display:flex}.f1IgfW_avatar{letter-spacing:.5px;text-transform:uppercase;border-radius:7px;flex:none;place-items:center;width:36px;height:36px;font-size:10px;font-weight:700;display:grid}.f1IgfW_agentIdentity{gap:2px;min-width:0;display:grid}.f1IgfW_agentName{color:var(--dsw-alias-label-primary,CanvasText);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;overflow:hidden}.f1IgfW_agentVersion{color:var(--dsw-alias-label-tertiary,GrayText);font-family:ui-monospace,monospace;font-size:11px}.f1IgfW_agentStat{border-top:1px solid var(--dsw-alias-border-l2,#8080801f);justify-content:space-between;align-items:center;padding-top:9px;display:flex}.f1IgfW_agentStatLabel{color:var(--dsw-alias-label-tertiary,GrayText);font-size:11px}.f1IgfW_agentStatPill{background:var(--dsw-alias-bg-module-platform,#80808014);color:var(--dsw-alias-label-secondary,GrayText);border-radius:999px;padding:2px 8px;font-size:11px;font-weight:600}.f1IgfW_agentStatError{background:var(--dsw-alias-state-error-secondary,#f25a5a1f);color:var(--dsw-alias-state-error-primary,LinkText)}.f1IgfW_flowRow{align-items:center;min-height:68px;padding:0 12px;transition:background-color .12s;display:flex}.f1IgfW_flowRow:has(.f1IgfW_flowButton:hover){background:var(--dsw-alias-bg-module-platform,#80808014)}.f1IgfW_flowName{font-size:12.5px;font-weight:600;line-height:1.45}.f1IgfW_listRow{width:100%;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;align-items:flex-start;gap:0;padding:9px 12px;display:flex}.f1IgfW_listRow:hover{background:var(--dsw-alias-bg-module-platform,#80808014)}.f1IgfW_listRow,.f1IgfW_flowRow,.f1IgfW_defnRow{position:relative}.f1IgfW_listRow:after,.f1IgfW_flowRow:after,.f1IgfW_defnRow:after{content:\"\";background:var(--dsw-alias-border-l2,#8080801f);height:1px;position:absolute;bottom:0;left:12px;right:12px}.f1IgfW_defnRow:after{left:0}.f1IgfW_listRow:last-child:after,.f1IgfW_flowRow:last-child:after,.f1IgfW_defnRow:last-child:after{display:none}.f1IgfW_listDot{flex:none;margin-top:4px}.f1IgfW_listMain{flex:auto;grid-template-columns:minmax(0,1fr);gap:1px;min-width:0;display:grid}.f1IgfW_listGoal{-webkit-line-clamp:2;-webkit-box-orient:vertical;font-size:12.5px;line-height:1.4;display:-webkit-box;overflow:hidden}.f1IgfW_listPrompt{-webkit-line-clamp:2;color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;white-space:normal;-webkit-box-orient:vertical;font-size:11px;line-height:1.45;display:-webkit-box;overflow:hidden}.f1IgfW_back{width:fit-content;color:var(--dsw-alias-state-business-primary,Highlight);cursor:pointer;background:0 0;border:0;border-radius:10px;align-self:flex-start;align-items:center;gap:5px;margin:6px;padding:6px 10px;font-size:14px;font-weight:500;transition:background-color .12s;display:flex}.f1IgfW_backArrow{font-size:16px;line-height:1}.f1IgfW_back:hover{background:var(--dsw-alias-bg-module-platform,#80808014)}.f1IgfW_back:hover .f1IgfW_backLabel{text-decoration:none}.f1IgfW_goalTitle{text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;font-weight:600;line-height:1.4;overflow:hidden}.f1IgfW_goalPromptCard{background:var(--dsw-alias-bg-module-platform,#80808014);border-radius:6px;min-width:0;max-width:100%;margin:3px 0 0;padding:6px 8px}.f1IgfW_goalPrompt{min-width:0;max-width:100%;color:var(--dsw-alias-label-secondary,GrayText);white-space:pre-wrap;overflow-wrap:anywhere;-webkit-box-orient:vertical;margin:0;font-family:inherit;font-size:11.5px;line-height:1.5;display:-webkit-box;overflow:hidden}.f1IgfW_goalPrompt[data-open]{display:block}.f1IgfW_goalPromptToggle{color:var(--dsw-alias-state-business-primary,Highlight);font:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;margin-top:4px;padding:0;font-size:11px;display:flex}.f1IgfW_goalPromptToggle:hover{text-decoration:underline}.f1IgfW_goalPromptChevronOpen{transform:rotate(180deg)}.f1IgfW_authoringStages{--orbit-step-line:26px;padding:2px 0 6px}.f1IgfW_authoringStages .f1IgfW_stepDisclosure{position:relative}.f1IgfW_authoringStages .f1IgfW_stepDisclosure:before{content:\"\";top:0;bottom:0;left:var(--orbit-step-line);background:var(--dsw-alias-label-tertiary,#808080b3);width:1px;margin-left:-.5px;position:absolute}.f1IgfW_authoringStages .f1IgfW_stepDisclosure:first-child:before{top:16px}.f1IgfW_authoringStages .f1IgfW_stepDisclosure:last-child:before{bottom:calc(100% - 16px)}.f1IgfW_authoringStages .f1IgfW_stepDot{z-index:1;position:relative}.f1IgfW_authoringStages .f1IgfW_stepRow{cursor:default}.f1IgfW_resultBlock{gap:3px;padding:4px 12px 8px 22px;display:grid}.f1IgfW_resultLabel{color:var(--dsw-alias-label-tertiary,GrayText);letter-spacing:.02em;font-size:10.5px}.f1IgfW_outcome{font-size:12px;font-weight:600}.f1IgfW_outcome_done{color:var(--dsw-alias-state-success-primary,#22c55e)}.f1IgfW_outcome_error{color:var(--dsw-alias-state-error-primary,#f25a5a)}.f1IgfW_outcome_warning{color:var(--dsw-alias-state-warn-primary,#f59e0b)}.f1IgfW_outcome_ongoing{color:var(--dsw-alias-state-business-primary,#679efe)}.f1IgfW_artifactRow{gap:4px;display:grid}.f1IgfW_artifactText{background:var(--dsw-alias-bg-module-platform,#80808014);max-width:100%;max-height:240px;color:var(--dsw-alias-label-primary);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:6px;margin:0;padding:6px 8px;font-family:inherit;font-size:11.5px;line-height:1.5;overflow:hidden auto}.f1IgfW_artifacts{flex-wrap:wrap;gap:6px;display:flex}.f1IgfW_artifactPath{background:var(--dsw-alias-bg-module-platform,#80808014);max-width:100%;color:var(--dsw-alias-label-secondary,GrayText);overflow-wrap:anywhere;user-select:all;border-radius:6px;padding:4px 8px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10.5px;line-height:1.5}.f1IgfW_artifact{border:1px solid var(--dsw-alias-border-l3,#80808029);max-width:100%;color:var(--dsw-alias-state-business-primary,Highlight);text-overflow:ellipsis;white-space:nowrap;border-radius:999px;padding:3px 8px;font-size:11px;text-decoration:none;overflow:hidden}a.f1IgfW_artifact:hover{text-decoration:underline}.f1IgfW_result{background:var(--dsw-alias-bg-module-platform,#80808014);max-height:220px;color:var(--dsw-alias-label-primary);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:6px;margin:0;padding:6px 8px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;line-height:1.5;overflow:auto}.f1IgfW_resultError{color:var(--dsw-alias-state-error-primary)}.f1IgfW_goalCard{border-bottom:1px solid var(--dsw-alias-border-l2,#8080801f)}.f1IgfW_goalCard:last-child{border-bottom:0}.f1IgfW_goalHead{align-items:flex-start;gap:9px;width:100%;padding:9px 12px 6px;display:flex}.f1IgfW_goalSteps{--orbit-step-line:26px;padding-bottom:6px}.f1IgfW_goalSteps .f1IgfW_stepDisclosure{position:relative}.f1IgfW_goalSteps .f1IgfW_stepDisclosure:before{content:\"\";top:0;bottom:0;left:var(--orbit-step-line);background:var(--dsw-alias-label-tertiary,#808080b3);width:1px;margin-left:-.5px;position:absolute}.f1IgfW_goalSteps .f1IgfW_stepDisclosure:first-child:before{top:16px}.f1IgfW_goalSteps .f1IgfW_stepDisclosure:last-child:before{bottom:calc(100% - 16px)}.f1IgfW_goalSteps .f1IgfW_stepDisclosure:only-child:before{display:none}.f1IgfW_goalSteps .f1IgfW_stepDot{z-index:1;position:relative}.f1IgfW_detailHead{align-items:baseline;gap:8px;padding:0 12px;display:flex}.f1IgfW_detailGoal{font-size:13px;font-weight:650;line-height:1.4}.f1IgfW_detailMeta{border-bottom:1px solid var(--dsw-alias-border-l2,#8080801f);color:var(--dsw-alias-label-tertiary,GrayText);padding:2px 12px 8px;font-size:11px}.f1IgfW_flowButton{min-width:0;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;flex:auto;align-self:stretch;padding:9px 0;display:block}.f1IgfW_flowButton:hover{color:var(--dsw-alias-state-business-primary,Highlight);background:0 0}.f1IgfW_flowNewGoal{min-height:32px;color:var(--dsw-alias-label-secondary,GrayText);cursor:pointer;background:0 0;border:0;border-radius:10px;flex:none;margin-left:12px;padding:6px 10px;font-size:11.5px;font-weight:600;transition:background-color .12s}.f1IgfW_flowNewGoal:hover:not(:disabled){background:var(--dsw-alias-bg-module-platform,#80808014);text-decoration:none}.f1IgfW_flowNewGoal:disabled{opacity:.45;cursor:not-allowed}.f1IgfW_prose{color:var(--dsw-alias-label-secondary,GrayText);margin:0;padding:8px 12px;font-size:12px;line-height:1.55}.f1IgfW_workflowDetail{flex-direction:column;min-height:100%;display:flex}.f1IgfW_workflowDetail .f1IgfW_detailMeta,.f1IgfW_workflowDetailTabs,.f1IgfW_workflowActions,.f1IgfW_workflowDetail .f1IgfW_sectionLabel{position:relative}.f1IgfW_workflowDetail .f1IgfW_detailMeta{border-bottom:0}.f1IgfW_workflowDetailTabs{border:0;padding:0 12px;display:flex}.f1IgfW_workflowDetail .f1IgfW_detailMeta:after,.f1IgfW_workflowDetailTabs:before,.f1IgfW_workflowDetailTabs:after,.f1IgfW_workflowActions:before,.f1IgfW_workflowDetail .f1IgfW_sectionLabel:before{content:\"\";background:var(--dsw-alias-border-l2,#8080801f);height:1px;position:absolute;left:12px;right:12px}.f1IgfW_workflowDetail .f1IgfW_detailMeta:after,.f1IgfW_workflowDetailTabs:after{bottom:0}.f1IgfW_workflowDetailTabs:before,.f1IgfW_workflowActions:before,.f1IgfW_workflowDetail .f1IgfW_sectionLabel:before{top:0}.f1IgfW_workflowDetailTab,.f1IgfW_workflowDetailTabActive{color:var(--dsw-alias-label-tertiary,GrayText);cursor:pointer;background:0 0;border:0;padding:8px 10px;font-size:11.5px;position:relative}.f1IgfW_workflowDetailTabActive{color:var(--dsw-alias-label-primary,CanvasText);font-weight:600}.f1IgfW_workflowDetailTabActive:after{content:\"\";background:var(--dsw-alias-state-business-primary,Highlight);height:2px;position:absolute;bottom:-1px;left:8px;right:8px}.f1IgfW_workflowGraph{background:var(--dsw-alias-bg-base,Canvas);flex:none;width:auto;height:300px;min-height:240px;margin:0 12px}.f1IgfW_workflowDefinitionPanel{margin:0 12px}.f1IgfW_workflowGraph .react-flow__controls{border:1px solid var(--dsw-alias-border-l3,#80808029);box-shadow:none;border-radius:8px;overflow:hidden}.f1IgfW_workflowGraph .react-flow__controls-button{border-bottom-color:var(--dsw-alias-border-l2,#8080801f);background:var(--dsw-alias-bg-layer-1,Canvas);color:var(--dsw-alias-label-primary,CanvasText)}.f1IgfW_workflowGraph .react-flow__edge-text{fill:var(--dsw-alias-label-secondary,GrayText);font-size:10px}.f1IgfW_workflowGraph .react-flow__edge-textbg{fill:var(--dsw-alias-bg-base,Canvas)}.f1IgfW_graphNode{border:1px solid var(--dsw-alias-border-l3,#80808029);background:var(--dsw-alias-bg-layer-1,Canvas);min-width:210px;color:var(--dsw-alias-label-primary,CanvasText);border-radius:8px;padding:8px 10px;position:relative}.f1IgfW_graphNode_action{border-left:3px solid var(--dsw-alias-state-business-primary,#679efed9)}.f1IgfW_graphNode_human{border-left:3px solid var(--dsw-alias-state-warn-primary,#f59e0bd9)}.f1IgfW_graphNode_terminal{border-left:3px solid var(--dsw-alias-state-success-primary,#22c55ed9)}.f1IgfW_graphNode_decision{border-left:3px solid var(--dsw-alias-state-warn-primary,#d97706)}.f1IgfW_graphNode_join{border-left:3px solid var(--dsw-alias-label-tertiary,GrayText)}.f1IgfW_graphNodeKind{color:var(--dsw-alias-label-tertiary,GrayText);letter-spacing:.06em;text-transform:uppercase;font-size:10px;display:block}.f1IgfW_graphNodeTitle{margin-top:2px;font-size:13px;font-weight:600;display:block}.f1IgfW_graphNodeHandler{color:var(--dsw-alias-label-tertiary,GrayText);margin-top:6px;font:11px/1.35 ui-monospace,SFMono-Regular,Menlo,monospace;display:block}.f1IgfW_graphNode .react-flow__handle{opacity:0;width:7px;height:7px}.f1IgfW_workflowActions{border-top:0;align-items:center;gap:6px;padding:8px 12px;display:flex}.f1IgfW_workflowAction,.f1IgfW_workflowPrimaryAction,.f1IgfW_workflowDangerAction{border:1px solid var(--dsw-alias-border-l3,#80808029);background:var(--dsw-alias-bg-module-platform,#80808014);min-height:30px;color:var(--dsw-alias-label-primary,CanvasText);cursor:pointer;border-radius:7px;align-items:center;padding:5px 10px;font-size:11.5px;text-decoration:none;display:inline-flex}.f1IgfW_workflowPrimaryAction{background:var(--dsw-alias-state-business-primary,Highlight);color:var(--dsw-alias-label-on-color,HighlightText);border-color:#0000}.f1IgfW_workflowDangerAction{border-color:var(--dsw-alias-state-error-primary,#f25a5a);color:var(--dsw-alias-state-error-primary,LinkText);background:0 0}.f1IgfW_workflowDangerAction:disabled{opacity:.55;cursor:default}.f1IgfW_workflowDeleteConfirm{border:1px solid var(--dsw-alias-border-l3,#80808029);background:var(--dsw-alias-bg-module-platform,#80808014);color:var(--dsw-alias-label-secondary,GrayText);border-radius:8px;gap:7px;margin:0 12px 8px;padding:10px;font-size:11.5px;display:grid}.f1IgfW_workflowDeleteConfirm strong{color:var(--dsw-alias-label-primary,CanvasText);font-size:12px}.f1IgfW_workflowDeleteConfirm code{overflow-wrap:anywhere;font-size:10.5px}.f1IgfW_sectionLabel{border-top:1px solid var(--dsw-alias-border-l2,#8080801f);color:var(--dsw-alias-label-tertiary,GrayText);padding:8px 12px 4px;font-size:11px}.f1IgfW_workflowDetail .f1IgfW_sectionLabel{border-top:0}.f1IgfW_defnRow{border-left:2px solid var(--dsw-alias-label-tertiary,#adb2b8b3);padding:8px 12px 9px}.f1IgfW_kind_action{border-left-color:var(--dsw-alias-state-business-primary,#679efed9)}.f1IgfW_kind_human{border-left-color:var(--dsw-alias-state-warn-primary,#f59e0bd9)}.f1IgfW_kind_terminal{border-left-color:var(--dsw-alias-state-success-primary,#22c55ed9)}.f1IgfW_kind_decision{border-left-color:var(--dsw-alias-label-secondary,#cfd3d6d9)}.f1IgfW_kind_join{border-left-color:var(--dsw-alias-label-tertiary,#adb2b8b3)}.f1IgfW_defnHead{align-items:baseline;gap:6px;min-width:0;display:flex}.f1IgfW_defnName{text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:0;font-size:12.5px;font-weight:600;overflow:hidden}.f1IgfW_defnKind{color:var(--dsw-alias-label-tertiary,GrayText);letter-spacing:.04em;text-transform:uppercase;flex:none;font-size:10px}.f1IgfW_defnHandler{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary,GrayText);flex:0 auto;margin-left:auto;font-family:ui-monospace,monospace;font-size:11px;overflow:hidden}.f1IgfW_defnPrompt,.f1IgfW_defnNoPrompt{color:var(--dsw-alias-label-secondary,GrayText);-webkit-line-clamp:3;-webkit-box-orient:vertical;margin:3px 0 0;font-size:11.5px;line-height:1.5;display:-webkit-box;overflow:hidden}.f1IgfW_defnNoPrompt{color:var(--dsw-alias-label-tertiary,GrayText);font-style:italic}.f1IgfW_shape{align-items:center;margin-top:5px;display:flex}.f1IgfW_shapeNode{border:1px solid var(--dsw-alias-border-l3,#80808029);width:15px;height:15px;color:var(--dsw-alias-state-business-primary,#5078ffe6);border-radius:50%;flex:0 0 15px;place-items:center;font-family:ui-monospace,monospace;font-size:7.5px;font-weight:700;line-height:1;display:grid;position:relative}.f1IgfW_shapeNode+.f1IgfW_shapeNode{margin-left:8px}.f1IgfW_shapeNode+.f1IgfW_shapeNode:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l3,#80808029);width:8px;position:absolute;top:50%;right:100%}.f1IgfW_node_human{color:var(--dsw-alias-state-warn-primary,#c88c28f2)}.f1IgfW_node_terminal{color:var(--dsw-alias-state-success-primary,#3ca05af2)}.f1IgfW_node_decision{color:var(--dsw-alias-label-secondary,GrayText)}.f1IgfW_node_more{color:var(--dsw-alias-label-tertiary,GrayText);font-size:7px}.f1IgfW_flowBlocked{color:var(--dsw-alias-state-warn-primary,#f59e0b);margin-left:6px;font-size:10px;font-weight:500}.f1IgfW_authoringRow{border-bottom:1px solid var(--dsw-alias-border-l2,#8080801f);background:var(--dsw-alias-bg-module-platform,#80808014);padding:9px 12px}.f1IgfW_authoringSummary{align-items:flex-start;gap:8px;display:flex}.f1IgfW_authoringMain{flex:auto;gap:2px;min-width:0;display:grid}.f1IgfW_authoringLabel{font-size:12px;font-weight:600;line-height:1.4}.f1IgfW_authoringPrompt{color:var(--dsw-alias-label-secondary,GrayText);-webkit-line-clamp:2;-webkit-box-orient:vertical;font-size:11px;line-height:1.45;display:-webkit-box;overflow:hidden}.f1IgfW_authoringOutputToggle{width:24px;height:24px;color:var(--dsw-alias-label-secondary,GrayText);cursor:pointer;background:0 0;border:0;flex:none;place-items:center;padding:0;display:grid}.f1IgfW_authoringOutputToggle svg{transition:transform .15s}.f1IgfW_authoringChevronOpen{transform:rotate(180deg)}.f1IgfW_authoringOutput{border:1px solid var(--dsw-alias-border-l3,#80808029);background:var(--dsw-alias-bg-base,Canvas);border-radius:6px;max-height:180px;margin:8px 0 0 16px;padding:8px;overflow:auto}.f1IgfW_authoringOutput pre{white-space:pre-wrap;overflow-wrap:anywhere;margin:0;font:11px/1.5 ui-monospace,SFMono-Regular,Menlo,monospace}";
		const tagId$1 = "@orbit-runtime/dsh-orbit/OrbitPanel.module.css";
		...
		var OrbitPanel_module_css_default = {
			"actions": "f1IgfW_actions",
			"agentCard": "f1IgfW_agentCard",
			"agentHead": "f1IgfW_agentHead",
			"agentIdentity": "f1IgfW_agentIdentity",
			"agentName": "f1IgfW_agentName",
			"agentStat": "f1IgfW_agentStat",
			"agentStatError": "f1IgfW_agentStatError",
			"agentStatLabel": "f1IgfW_agentStatLabel",
			"agentStatPill": "f1IgfW_agentStatPill",
			"agentVersion": "f1IgfW_agentVersion",
			"agentsGrid": "f1IgfW_agentsGrid",
			"artifact": "f1IgfW_artifact",
			"artifactPath": "f1IgfW_artifactPath",
			"artifactRow": "f1IgfW_artifactRow",
			"artifactText": "f1IgfW_artifactText",
			"artifacts": "f1IgfW_artifacts",
			"attention": "f1IgfW_attention",
			"authoringChevronOpen": "f1IgfW_authoringChevronOpen",
			"authoringLabel": "f1IgfW_authoringLabel",
			"authoringMain": "f1IgfW_authoringMain",
			"authoringOutput": "f1IgfW_authoringOutput",
			"authoringOutputToggle": "f1IgfW_authoringOutputToggle",
			"authoringPrompt": "f1IgfW_authoringPrompt",
			"authoringRow": "f1IgfW_authoringRow",
			"authoringStages": "f1IgfW_authoringStages",
			"authoringSummary": "f1IgfW_authoringSummary",
			"avatar": "f1IgfW_avatar",
			"back": "f1IgfW_back",
			"backArrow": "f1IgfW_backArrow",
			"backLabel": "f1IgfW_backLabel",
			"badge": "f1IgfW_badge",
			"bar": "f1IgfW_bar",
			"body": "f1IgfW_body",
			"catalogRow": "f1IgfW_catalogRow",
			"confirmActions": "f1IgfW_confirmActions",
			"confirmBar": "f1IgfW_confirmBar",
			"confirmCancel": "f1IgfW_confirmCancel",
			"confirmGo": "f1IgfW_confirmGo",
			"confirmText": "f1IgfW_confirmText",
			"connectSpinner": "f1IgfW_connectSpinner",
			"connecting": "f1IgfW_connecting",
			"count": "f1IgfW_count",
			"defnHandler": "f1IgfW_defnHandler",
			"defnHead": "f1IgfW_defnHead",
			"defnKind": "f1IgfW_defnKind",
			"defnName": "f1IgfW_defnName",
			"defnNoPrompt": "f1IgfW_defnNoPrompt",
			"defnPrompt": "f1IgfW_defnPrompt",
			"defnRow": "f1IgfW_defnRow",
			"detailGoal": "f1IgfW_detailGoal",
			"detailHead": "f1IgfW_detailHead",
			"detailMeta": "f1IgfW_detailMeta",
			"done": "f1IgfW_done",
			"dot": "f1IgfW_dot",
			"empty": "f1IgfW_empty",
			"error": "f1IgfW_error",
			"failed": "f1IgfW_failed",
			"flowBlocked": "f1IgfW_flowBlocked",
			"flowButton": "f1IgfW_flowButton",
			"flowName": "f1IgfW_flowName",
			"flowNewGoal": "f1IgfW_flowNewGoal",
			"flowRow": "f1IgfW_flowRow",
			"goal": "f1IgfW_goal",
			"goalCard": "f1IgfW_goalCard",
			"goalHead": "f1IgfW_goalHead",
			"goalPrompt": "f1IgfW_goalPrompt",
			"goalPromptCard": "f1IgfW_goalPromptCard",
			"goalPromptChevronOpen": "f1IgfW_goalPromptChevronOpen",
			"goalPromptToggle": "f1IgfW_goalPromptToggle",
			"goalSteps": "f1IgfW_goalSteps",
			"goalTitle": "f1IgfW_goalTitle",
			"graphNode": "f1IgfW_graphNode",
			"graphNodeHandler": "f1IgfW_graphNodeHandler",
			"graphNodeKind": "f1IgfW_graphNodeKind",
			"graphNodeTitle": "f1IgfW_graphNodeTitle",
			"graphNode_action": "f1IgfW_graphNode_action",
			"graphNode_decision": "f1IgfW_graphNode_decision",
			"graphNode_human": "f1IgfW_graphNode_human",
			"graphNode_join": "f1IgfW_graphNode_join",
			"graphNode_terminal": "f1IgfW_graphNode_terminal",
			"iconButton": "f1IgfW_iconButton",
			"kind_action": "f1IgfW_kind_action",
			"kind_decision": "f1IgfW_kind_decision",
			"kind_human": "f1IgfW_kind_human",
			"kind_join": "f1IgfW_kind_join",
			"kind_terminal": "f1IgfW_kind_terminal",
			"listDot": "f1IgfW_listDot",
			"listGoal": "f1IgfW_listGoal",
			"listMain": "f1IgfW_listMain",
			"listPrompt": "f1IgfW_listPrompt",
			"listRow": "f1IgfW_listRow",
			"live": "f1IgfW_live",
			"meta": "f1IgfW_meta",
			"node_decision": "f1IgfW_node_decision",
			"node_human": "f1IgfW_node_human",
			"node_more": "f1IgfW_node_more",
			"node_terminal": "f1IgfW_node_terminal",
			"orbit-spin": "f1IgfW_orbit-spin",
			"orbitBackground": "f1IgfW_orbitBackground",
			"orbitMark": "f1IgfW_orbitMark",
			"orbitRing": "f1IgfW_orbitRing",
			"orbitSatellite": "f1IgfW_orbitSatellite",
			"outcome": "f1IgfW_outcome",
			"outcome_done": "f1IgfW_outcome_done",
			"outcome_error": "f1IgfW_outcome_error",
			"outcome_ongoing": "f1IgfW_outcome_ongoing",
			"outcome_warning": "f1IgfW_outcome_warning",
			"panel": "f1IgfW_panel",
			"prose": "f1IgfW_prose",
			"resize": "f1IgfW_resize",
			"result": "f1IgfW_result",
			"resultBlock": "f1IgfW_resultBlock",
			"resultError": "f1IgfW_resultError",
			"resultLabel": "f1IgfW_resultLabel",
			"row": "f1IgfW_row",
			"runActions": "f1IgfW_runActions",
			"sectionLabel": "f1IgfW_sectionLabel",
			"shape": "f1IgfW_shape",
			"shapeNode": "f1IgfW_shapeNode",
			"status": "f1IgfW_status",
			"stepChevron": "f1IgfW_stepChevron",
			"stepChevronOpen": "f1IgfW_stepChevronOpen",
			"stepContent": "f1IgfW_stepContent",
			"stepDisclosure": "f1IgfW_stepDisclosure",
			"stepDot": "f1IgfW_stepDot",
			"stepDot_error": "f1IgfW_stepDot_error",
			"stepDot_ongoing": "f1IgfW_stepDot_ongoing",
			"stepDot_skipped": "f1IgfW_stepDot_skipped",
			"stepDot_success": "f1IgfW_stepDot_success",
			"stepDot_warning": "f1IgfW_stepDot_warning",
			"stepRow": "f1IgfW_stepRow",
			"stepTitle": "f1IgfW_stepTitle",
			"stopButton": "f1IgfW_stopButton",
			"tab": "f1IgfW_tab",
			"tabActive": "f1IgfW_tabActive",
			"tabs": "f1IgfW_tabs",
			"title": "f1IgfW_title",
			"unknown": "f1IgfW_unknown",
			"workflowAction": "f1IgfW_workflowAction",
			"workflowActions": "f1IgfW_workflowActions",
			"workflowDangerAction": "f1IgfW_workflowDangerAction",
			"workflowDefinitionPanel": "f1IgfW_workflowDefinitionPanel",
			"workflowDeleteConfirm": "f1IgfW_workflowDeleteConfirm",
			"workflowDetail": "f1IgfW_workflowDetail",
			"workflowDetailTab": "f1IgfW_workflowDetailTab",
			"workflowDetailTabActive": "f1IgfW_workflowDetailTabActive",
			"workflowDetailTabs": "f1IgfW_workflowDetailTabs",
			"workflowGraph": "f1IgfW_workflowGraph",
			"workflowPrimaryAction": "f1IgfW_workflowPrimaryAction"
		};
		//#endregion
		...
		*/
		function readLayout(raw) {
			...
			return {
				...
				width: clamp$1(finite(stored.width, 400), 320, 720),
		...
		function placePanel(layout, bounds) {
			...
			const width = compact ? Math.max(320, bounds.width - 24) : clamp$1(layout.width, 320, maxWidth);
			...
			const height = clamp$1(layout.height, 280, Math.max(280, bounds.height - 24));
			return {
				left: clamp$1(layout.x, 12, Math.max(12, bounds.width - width - 12)),
				top: clamp$1(layout.y, 12, Math.max(12, bounds.height - height - 12)),
				width,
				height
			};
		}
		...
		function dragPanel(layout, dx, dy, bounds) {
			...
			return {
				...layout,
				mode: "floating",
				x: clamp$1(placed.left + dx, 12, Math.max(12, bounds.width - placed.width - 12)),
				y: clamp$1(placed.top + dy, 12, Math.max(12, bounds.height - placed.height - 12))
			};
		}
		...
		function resizePanel(layout, dWidth, dHeight, bounds) {
			...
			return {
				...layout,
				width: clamp$1(layout.width + dWidth, 320, maxWidth),
				height: clamp$1(layout.height + dHeight, 280, Math.max(280, bounds.height - 24))
			};
		}
		//#endregion
		...
		*/
		function RunControls({ call, t, sessionId, run }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				}) : null, resumeAt === void 0 ? null : approval !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
					value: answer,
					placeholder: t("reason"),
					onChange: (event) => setAnswer(event.currentTarget.value)
				}), ["approve", "reject"].map((decision) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
					size: "sm",
					variant: decision === "approve" ? "primary" : "outline",
					disabled: busy,
					onClick: () => act("langgraph_run.resume", resumeAt, approvalValue(approval, decision, answer), approval.id),
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/cxd/develop/orbit/.claude/worktrees/rework/integrations/deepseek-harness/node_modules/@xyflow/react/dist/style.css.mjs
		...
		const tagId = "@orbit-runtime/dsh-orbit/style.css";
			...
			const model = (0, react.useMemo)(() => {
				...
				return {
					nodes: (graph.nodes ?? []).map((node) => {
						const spot = positions.get(node.node_id) ?? {
							depth: 0,
							lane: 0
						};
						return {
							...
							type: "workflow",
							position: {
								x: spot.depth * DEPTH_WIDTH,
								y: spot.lane * LANE_HEIGHT
							},
							draggable: false,
							selectable: false,
							connectable: false,
		...
		* as Orbit's MCP App card. */
		...
		function OrbitWorkflowDetail({ call, t, sessionId, workflow, runs, onBack, onNewGoal, onModify, onDelete, onOpenRun }) {
			...
			const [view, setView] = (0, react.useState)("graph");
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					confirmingDelete ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("deleteWorkflowTitle") }),
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									...
									onClick: () => {
										setDeleting(true);
										setDeleteError(null);
										onDelete().then(() => setConfirmingDelete(false)).catch((reason) => setDeleteError(panelError(reason))).finally(() => setDeleting(false));
									},
									children: deleting ? t("working") : t("deleteConfirm")
								})]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PanelErrorText, {
								t,
		...
		*/
		...
		const en = {
			...
			workflowViews: "Workflow detail views",
			workflowGraph: "Graph",
			workflowDefinition: "Definition",
			noWorkflowGraph: "No graph is available for this workflow.",
			newGoal: "New goal",
			editWorkflow: "Modify",
			deleteWorkflow: "Delete",
			deleteWorkflowTitle: "Delete this workflow?",
			deleteCancel: "Cancel",
			deleteConfirm: "Delete",
			editWorkflowPrompt: "Modify workflow “{name}” ({id}) as follows:",
			deleteWorkflowPrompt: "I confirm deleting workflow {id} ({name}). Re-read its latest version, then use the authorized delete_workflow tool with a new idempotency key to delete it.",
			...
			approve: "Approve",
			reject: "Reject",
			reason: "Why? A rework reads this.",
		...
		const zh = {
			...
			factSteps: "步骤（{total}）",
			stepsLoading: "正在读取定义…",
			workflowViews: "工作流详情视图",
			workflowGraph: "流程图",
			workflowDefinition: "定义列表",
			noWorkflowGraph: "这个工作流没有可显示的流程图。",
			newGoal: "新目标",
			editWorkflow: "修改",
			deleteWorkflow: "删除",
			deleteWorkflowTitle: "确认删除工作流？",
			deleteCancel: "取消",
			deleteConfirm: "确认删除",
			editWorkflowPrompt: "按照下面的要求修改工作流「{name}」（{id}）：",
			deleteWorkflowPrompt: "我确认删除工作流{id}（{name}）。请重新读取其最新版本，并使用授权的 delete_workflow 工具和新的幂等键执行删除。",
			noPrompt: "这一步没有写提示词。",
			noOutput: "这个步骤没有输出。",

...
def create_app(
    ...
    *,
    ...
    if discover_agents:
        ...
        # default, and never the directory `paf serve` was started in: an
    ...
    # than inside the route factory so `paf mcp` can carry this very
    ...
    # `paf mcp` reaches the tools through this instead of over its own HTTP

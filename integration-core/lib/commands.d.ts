 ...
 */
export declare function advertisedAt(run: RunDto, command: PromptaFlowRunCommand, expectedRevision: number): {
    command: string;
    expected_version: number;
} | undefined;
/** The wire tool one command is carried by. */
export declare function commandTool(command: PromptaFlowRunCommand): 'cancel_run' | 'resume_run';

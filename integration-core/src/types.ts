...
export interface ArtifactSummary { artifact_id: string; run_id: string; content_type?: string; size_bytes?: number; filename?: string | null; [key: string]: unknown }

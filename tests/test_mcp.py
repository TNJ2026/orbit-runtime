...
class HandshakeTests(ApiTestCase):
    ...
    def test_workspace_resource_is_discoverable_and_readable(self) -> None:
        with AsgiHarness(self.app) as client:
            ...
            self.assertEqual(
                {
                    "ui://promptaflow/current-task-v56.html", "ui://promptaflow/workflows-v29.html",
                    "ui://promptaflow/workflow-authoring-v17.html", "ui://promptaflow/goal-run-v25.html",
...
class DiscoveryTests(ApiTestCase):
    def test_tools_are_discoverable_with_schemas(self) -> None:
        with AsgiHarness(self.app) as client:
            ...
            self.assertEqual(
                {
                    ...
                    "get_artifact_lineage", "collect_artifacts", "publish_run_files",
            ...
            self.assertEqual(
                "ui://promptaflow/current-task-v56.html",
                dashboard["_meta"]["ui"]["resourceUri"],
            )
            self.assertEqual(
                {
                    "open_promptaflow_dashboard": "ui://promptaflow/current-task-v56.html",
            ...
            self.assertEqual("ui://promptaflow/goal-run-v25.html", card_bindings["start_run"])
    ...
    def test_prompt_modes_distinguish_editable_and_direct_actions(self) -> None:
        with AsgiHarness(self.app) as client:
            ...
            dashboard = rpc(
                client, "resources/read",
                {"uri": "ui://promptaflow/current-task-v56.html"}, actor="reader",
            ).json()["result"]["contents"][0]["text"]
...
class StdioTransportTests(ApiTestCase):
    ...
    def test_a_session_handshakes_and_lists_the_same_tools(self) -> None:
        ...
        self.assertEqual(36, len(responses[1]["result"]["tools"]))
